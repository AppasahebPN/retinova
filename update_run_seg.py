...
content = """function result = run_Segmentation(img)
% ============================================================
...
dest = r"C:\Users\Appasaheb\OneDrive\Documents\MATLAB\DR_Screening_MATLAB\module3_Segmentation\run_Segmentation.m"
